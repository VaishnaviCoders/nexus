...
/**
  ...
  /**
   * `prisma.leaveStatusTimeline`: Exposes CRUD operations for the **LeaveStatusTimeline** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more LeaveStatusTimelines
    * const leaveStatusTimelines = await prisma.leaveStatusTimeline.findMany()
    * ```
    */
  get leaveStatusTimeline(): Prisma.LeaveStatusTimelineDelegate<ExtArgs, { omit: OmitOpts }>;
