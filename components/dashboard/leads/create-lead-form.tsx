...
export function CreateLeadForm() {
  ...
  function onSubmit(data: CreateLeadFormData) {
        ...
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="relative mb-6">
              ...
              <CheckCircle2 className="relative w-20 h-20 text-emerald-500 animate-in fade-in zoom-in duration-500" />
            </div>
            <h3 className="text-3xl font-bold text-slate-900 mb-2 text-center">
              Lead Created Successfully!
            </h3>
            <p className="text-slate-600 text-center max-w-md">
              The new student inquiry has been registered in the system and is
              ready for follow-up.
            </p>
          </div>
        ) : (
