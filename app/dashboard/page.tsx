...
export default function PremiumAdminDashboard() {
  ...
  return (
    <div className="flex-1 space-y-6 p-6 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen">
      {/* Enhanced Header */}
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-slate-600">Avg Marks</div>
                    </div>
                  </div>
                </div>
              ))}
